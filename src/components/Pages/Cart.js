      ...
      {cartItems.length === 0 ? (
        ...
        <>
          <div className="shadow-md mt-4 container mx-auto md:px-4 py-4 md:w-2/3">
            ...
            <button className="md:hidden w-full hover:bg-orange-500 border-2 border-orange-500 flex p-3 justify-between items-center text-orange-400 hover:text-white text-sm font-semibold  rounded-md">
            ...
            <div className="hidden md:flex h-14 justify-around  mx-auto gap-10 w-9/12 font-semibold lg:text-lg md:text-sm text-orange-600">
              ...
              <button className=" p-4 hover:bg-orange-500 flex border-2 border-orange-500 items-center hover:text-white  w-1/2">
                <div className="flex items-center gap-2">
                  PROCEED TO PAY <BsArrowRightSquareFill />{" "}
                </div>
                <div className="p-1 w-28">₹ {totalAmount}</div>
